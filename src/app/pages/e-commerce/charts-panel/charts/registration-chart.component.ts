...
export class RegistrationChartComponent implements AfterViewInit, OnDestroy, OnChanges {

  @Input()
  registrationChartData: OrdersChart;
  ...
  ngOnChanges(): void {
    if (this.option) {
      this.updateOrdersChartOptions(this.registrationChartData);
    }
  }
