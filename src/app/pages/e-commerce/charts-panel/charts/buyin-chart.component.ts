...
export class BuyinChartComponent implements AfterViewInit, OnDestroy, OnChanges {

  @Input()
  buyinChartData: OrdersChart;
  ...
  ngOnChanges(): void {
    if (this.option) {
      this.updateOrdersChartOptions(this.buyinChartData);
    }
  }
