...
export class ActiveUserChartComponent implements AfterViewInit, OnDestroy, OnChanges {

  @Input()
  activeUserChartData: OrdersChart;
  ...
  ngOnChanges(): void {
    if (this.option) {
      this.updateOrdersChartOptions(this.activeUserChartData);
    }
  }
